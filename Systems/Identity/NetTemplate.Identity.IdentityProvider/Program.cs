...
using NetTemplate.Identity.IdentityProvider.Common.Extensions;
using NetTemplate.Identity.IdentityProvider.Common.Models;
using NetTemplate.Identity.Infrastructure.Common.Extensions;
...
using ApiRoutes = NetTemplate.Identity.IdentityProvider.Common.Constants.ApiRoutes;
using BackgroundConnectionNames = NetTemplate.Shared.Infrastructure.Background.Constants.ConnectionNames;
using CacheProfiles = NetTemplate.Identity.IdentityProvider.Common.Constants.CacheProfiles;
...
static RuntimeConfig GetRuntimeConfig()
{
    ...
    {
        typeof(NetTemplate.Identity.IdentityProvider.AssemblyType),
        typeof(NetTemplate.Identity.Infrastructure.AssemblyType),
        typeof(NetTemplate.Identity.ApplicationCore.AssemblyType)
    };
